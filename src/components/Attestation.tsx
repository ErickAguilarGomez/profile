...
export default function Attestation() {
    return (
        <>
            <div className="w-full bg-black pt-20" id="attestation">
                            ...
                            <div key={index} className="flex w-[100%] rounded-md shadow-md bg-black items-center justify-center ">
                                <div className="flex items-center w-3/4 border-b border-gray-600">
                                    ...
                                    <a href={cert.link} className="flex w-1/4 justify-end my-2" target="_blank">
                                        <img className="rounded-md w-24 h-auto" src={cert.imageUrl} alt={cert.title} style={{ position: 'relative', left: '0' }}/>
                                    </a>
                                </div>
                            </div>
                        ))}
